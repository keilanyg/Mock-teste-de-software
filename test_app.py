...
"""Fixture para criar uma simulação para a função obter_dados_API
 e define seu valor de retorno como {"message": "Hello, world!"}."""
@pytest.fixture
...
Espera-se que o resultado seja "Processed data: Hello, world!"""
def testar_dados_processo_API_com_dados(mock_obter_dados_API):
    result = processar_dados("http://fake-api.com")
    assert result == "Processed data: Testes de Mock!"
